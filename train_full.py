...
if DATASET_NAME == 'MIMIC':
    ...
    BATCH_SIZE = 12 if PHASE == 'TRAIN' else 64 # Fit 4 GPUs
    MILESTONES = [25] # Reduce LR by 10 after reaching milestone epochs
...
if __name__ == "__main__":
    ...
    if DATASET_NAME == 'MIMIC':
        ...
        dataset = NLMCXR('/home/chayan/IU-XRay/', INPUT_SIZE, view_pos=['AP','PA','LATERAL'], max_views=MAX_VIEWS, sources=SOURCES, targets=TARGETS)
